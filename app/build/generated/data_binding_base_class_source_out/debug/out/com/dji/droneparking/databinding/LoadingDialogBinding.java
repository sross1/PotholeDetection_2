...
public final class LoadingDialogBinding implements ViewBinding {
  ...
  private LoadingDialogBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static LoadingDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoadingDialogBinding((ConstraintLayout) rootView, progressBar, textView);
    }
